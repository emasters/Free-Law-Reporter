                ...
                if ($fdh = opendir($casedir.'/'.$curdir)){
                    while (false !== ($file = readdir($fdh))) {
                        if ($file != "." && $file != ".." && $file != "index.html") {
                            ...
                            $url = 'http://www.freelawreporter.org/flr3d/us/'.$curdir.'/'.$file;
                            ...
                            foreach($html->find('meta') as $element){
                               // Check for meta courtname and set it to SCOTUS
                               if ($element->name == 'courtname'){
                                   $element->content = 'Supreme Court of the United States';
                               }
                            ...
                            $rptser->setAttribute('content', 'United States Reports');
